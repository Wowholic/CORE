...
if ( carbon_get_theme_option( 'wwm_show_dev_grid' ) ) {
	function wwm_add_dev_grid_css() {
        ...
        <style type="text/css">
            ...
            .wwm-toggle-grid svg:last-child {
                display: none;
            }

            .wwm-toggle-grid.is-active svg:last-child {
                display: block;
            }

            .wwm-toggle-grid.is-active svg:first-child {
                display: none;
            }
	...
	function wwm_add_dev_grid() {
		$columns = carbon_get_theme_option( 'wwm_dev_grid_columns' );
		?>
        <button class="wwm-toggle-grid js-wwm-toggle-grid is-active">
            ...
            <svg width="512px" height="510px" viewBox="0 0 512 510" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <g id="visibility-on_1" transform="translate(0.000000, 80.000000)" fill="#000000" fill-rule="nonzero">
                        <path d="M254.4,238.6 C289.4,238.6 318,210 318,175 C318,140 289.4,111.4 254.4,111.4 C219.4,111.4 190.8,140 190.8,175 C190.8,210 219.4,238.6 254.4,238.6 Z M254.4,270.4 C200.3,270.4 159,229.1 159,175 C159,120.9 200.3,79.6 254.4,79.6 C308.5,79.6 349.8,120.9 349.8,175 C349.8,229.1 308.5,270.4 254.4,270.4 Z" id="Shape"></path>
                        <path d="M254.4,318.1 C343.4,318.1 416.6,270.4 473.8,171.8 C416.5,79.6 343.4,31.9 254.4,31.9 C165.3,31.9 95.4,76.4 38.1,171.8 C92.2,273.6 165.4,318.1 254.4,318.1 Z M254.4,0.1 C359.3,0.1 445.2,57.3 512,171.8 C445.2,292.7 359.4,349.9 254.4,349.9 C149.5,349.9 63.6,292.7 0,175 C63.6,60.5 146.3,0.1 254.4,0.1 Z" id="Shape"></path>
                    </g>
                </g>
        ...
        <div class="wwm-dev-grid js-dev-grid is-active">
            <div class="wwm-dev-grid_container">
                <div class="wwm-dev-grid_row">
					<?php for ( $i = 0; $i < intval( $columns ); $i ++ ): ?>
                        <div class="wwm-dev-grid_col"><span></span></div>
					<?php endfor; ?>
                </div>
            </div>
        </div>
        <script type="text/javascript">
            var toggleGrid = document.querySelector('.js-wwm-toggle-grid');
	...
	add_action( 'wp_head', 'wwm_add_dev_grid_css', 100 );
	add_action( 'wp_footer', 'wwm_add_dev_grid', 100 );
}