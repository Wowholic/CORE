...
function wwm_attach_page() {
	...
	$general_fields = [
		Field::make( 'checkbox', 'wwm_cleanup_wp_defaults', __( 'Cleanup WordPress defaults' ) )
		     ->set_default_value( true ),
		Field::make( 'checkbox', 'wwm_disable_file_edit', __( 'Disable Theme & Plugin Editors' ) )
		     ->set_default_value( true ),
	...
	$dev_grid_fields = [
		...
		Field::make( 'text', 'wwm_dev_grid_width', __( 'Container width (px)' ) )
		     ...
		     ->set_width( 20 ),
		Field::make( 'text', 'wwm_dev_grid_padding', __( 'Container padding (px)' ) )
